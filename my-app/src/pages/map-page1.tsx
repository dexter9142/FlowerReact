    ...
    <div className="map-page1">
      ...
      <div className="rectangle-group">
        ...
        <div className="results-found-parent">
          <div className="results-found2">20 results found</div>
          <div className="vecicle-card4">
            ...
            <div className="frame-parent30">
              <div className="peterbilt-579-parent2">
                <div className="div11">Tulips</div>
                <div className="frame-child46" />
                <div className="input-text10">flower</div>
              </div>
              <div className="frame-parent31">
                <div className="ohio-parent2">
                  <div className="ohio4">China</div>
                  <div className="frame-child46" />
                ...
                <div className="material-symbolsstar-parent2">
                  ...
                  />
                  <div className="ohio4">5,0 (12)</div>
                </div>
              </div>
              <div className="frame-wrapper4">
                <div className="day-wrapper2">
                  <div className="day4">$1</div>
                </div>
              </div>
            </div>
          </div>
